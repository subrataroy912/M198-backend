 ...
 * DataSeedRunner
 *
 * Populates MongoDB with localized academic entities reflecting North Bengal
 * (Siliguri, Jalpaiguri,
 * Darjeeling, Dooars) institutions including JGEC, SIT, NBU, Siliguri Govt
 * Polytechnic, and Jalpaiguri Polytechnic.
 *
...
public class DataSeedRunner implements CommandLineRunner {
        ...
        private void cleanPreviousSeedData() {
                ...
                List<User> existingSeedUsers = userRepository.findAll().stream()
                                .filter(u -> u.getEmail() != null
                                                && SEED_DOMAINS.stream().anyMatch(d -> u.getEmail().endsWith(d)))
                                .toList();
                ...
                for (String userId : seedUserIds) {
                        ...
                        notificationRepository.deleteAll(
                                        notificationRepository.findAllByRecipientIdOrderByCreatedAtDesc(userId, null)
                                                        .getContent());
        ...
        private void seedProfiles(Map<String, User> userMap, Instant now) {
                ...
                List<SeedProfileDefinition> profiles = List.of(
                                ...
                                new SeedProfileDefinition(
                                                "amitesh.c@sgpolytechnic.ac.in", "amitesh_sgp", "Amitesh",
                                                "Chakraborty",
        ...
        private Map<String, Course> seedCourses(Map<String, User> userMap, Instant now) {
                ...
                List<SeedCourseDefinition> courseDefs = List.of(
                                ...
                                new SeedCourseDefinition(
                                                ...
                                                "theme-rose",
                                                List.of("civil-engineering", "jgec", "geotechnical", "dooars",
                                                                "darjeeling")),
                                ...
                                new SeedCourseDefinition(
                                                ...
                                                "theme-blue",
                                                List.of("polytechnic", "sgp", "siliguri", "microprocessors",
                                                                "diploma")),
                ...
                Set<String> privateCourseKeys = Set.of("c_sit_ml", "c_jgec_cloud");

                for (SeedCourseDefinition def : courseDefs) {
                        CourseAccessType accessType = privateCourseKeys.contains(def.key)
                        ...
                        CourseDiscovery discovery = CourseDiscovery.builder()
                                        ...
                                        .accessType(course.getResolvedAccessType())
        ...
        private void seedMemberships(
                ...
                Map<String, List<MembershipAssignment>> courseEnrollments = Map.of(
                                "c_jgec_dsa", List.of(
                                                new MembershipAssignment("debasmita.ghosh@jgec.ac.in",
                                                ...
                                                new MembershipAssignment("tathagata.d@sit.ac.in",
                                ...
                                "c_sit_ml", List.of(
                                                ...
                                                new MembershipAssignment("tathagata.d@sit.ac.in",
                                                                MembershipRole.MEMBER),
                                                new MembershipAssignment("ananya.m@jgec.ac.in", MembershipRole.MEMBER),
                                                new MembershipAssignment("priyanka.p@sit.ac.in",
                                                                MembershipRole.MEMBER)),
                                "c_sit_iot", List.of(
                                                ...
                                                new MembershipAssignment("tanmoy.b@sgpolytechnic.ac.in",
                                                                MembershipRole.MEMBER)),
                                "c_nbu_tea", List.of(
                                ...
                                "c_jgec_civil", List.of(
                                                ...
                                                new MembershipAssignment("subhamita.r@jpicampus.ac.in",
                                                                MembershipRole.MEMBER)),
                                "c_sgp_micro", List.of(
                                                new MembershipAssignment("amitesh.c@sgpolytechnic.ac.in",
                                                                MembershipRole.OWNER),
                                                new MembershipAssignment("tanmoy.b@sgpolytechnic.ac.in",
                                                                MembershipRole.MEMBER),
                                                new MembershipAssignment("bikram.m@jgec.ac.in", MembershipRole.MEMBER),
                                ...
                                "c_jpi_survey", List.of(
                                                ...
                                                new MembershipAssignment("subhamita.r@jpicampus.ac.in",
                                                                MembershipRole.MEMBER),
                                                new MembershipAssignment("amitava.b@jgec.ac.in",
                                                                MembershipRole.MEMBER)));
