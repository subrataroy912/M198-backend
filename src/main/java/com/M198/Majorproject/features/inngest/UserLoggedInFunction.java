...
public class UserLoggedInFunction extends InngestFunction {
    ...
    public Object execute(FunctionContext context, Step step) {
        ...
        payload.put("eventName", event == null ? "user-logged-in" : event.getName());
        ...
        if (event != null && event.getData() != null) {
            ...
            payload.put("lastLoginAt", event.getData().getOrDefault("lastLoginAt", ""));
        }
