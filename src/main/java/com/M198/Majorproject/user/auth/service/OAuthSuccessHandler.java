    ...
    public void onAuthenticationSuccess(
        ...
        String targetUrl = UriComponentsBuilder
                ...
                .fragment(UriComponentsBuilder.newInstance()
                        ...
                        .queryParam("isNewUser", String.valueOf(result.isNewUser()))
                        .queryParam("profileCompleted", String.valueOf(result.isProfileCompleted()))
                        .queryParam("isLongTimeAway", String.valueOf(result.isLongTimeAway()))
                        .build()
                        .getQuery())
                .build()
                .toUriString();
