...
class CourseServiceTest {
    ...
    void createAndModifyCourseWithSpaceLinks() {
        com.M198.Majorproject.core.course.entity.SpaceLink link1 = com.M198.Majorproject.core.course.entity.SpaceLink.builder()
                .id("link-1")
                .title("Project Repo")
        ...
        com.M198.Majorproject.core.course.entity.SpaceLink link2 = com.M198.Majorproject.core.course.entity.SpaceLink.builder()
                .id("link-2")
