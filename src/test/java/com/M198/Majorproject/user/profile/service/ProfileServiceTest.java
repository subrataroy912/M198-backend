...
class ProfileServiceTest {
        ...
        private final AuthenticatedUserResolver userResolver = new AuthenticatedUserResolver(userRepository,
                        profileRepository);
        ...
        void polymorphicLookupResolvesByHandleAndAtHandle() {
                ...
                when(userRepository.findByIdAndActiveTrueAndStatus("user-3", AccountStatus.ACTIVE))
